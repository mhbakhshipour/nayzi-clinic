...
urlpatterns = [
    ...
    path('api/v1/auth/register/generate', RegisterAPI.as_view(), name='api_auth_register'),
    ...
    path('api/v1/auth/user/me', UpdateProfileAPI.as_view(), name='api_update_profile'),
]
